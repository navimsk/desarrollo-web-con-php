  ...
  <body class="login-page bg-body-secondary">
    <div class="login-box">
      <div class="login-logo">
        <a href="../../index2.html"><b>Faith</b>Barber</a>
      </div>
      <!-- /.login-logo -->
      <div class="card">
...
<?php endif; ?>
          ...
          <div class="social-auth-links text-center mb-3 d-grid gap-2">
            <p>- OR -</p>
            <a href="https://www.youtube.com/watch?v=_s0vNqpOxI0" class="btn btn-primary">
              <i class="bi bi-facebook me-2"></i> Inicia session con facebook
            </a>
            <a href="https://www.youtube.com/watch?v=t5RbJAneSUs&pp=ygUSdSBkZSBjaGlsZSB1YyAyMDEx" class="btn btn-danger">
          ...
          <p class="mb-1">
            <a href="../forgot/">Olvide mi contraseña :c</a>
          </p>
          <p class="mb-0">
            <a href="../create/" class="text-center"> Registrarme </a>
          </p>
        </div>
        <!-- /.login-card-body -->
      </div>
